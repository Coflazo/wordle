...
const EN = {
  ...
  setup: {
    ...
    dailyHint: 'Same word for everyone, changes at midnight',
    starting: 'Starting…',
  ...
  game: {
    ...
    sourceUnreachable: 'Could not reach the dictionary. Check your connection and try again.',
  ...
  errors: {
    ...
    offlineMode: 'You are offline. Finished games and stats still work; new guesses need a connection.',
...
const TR = {
  ...
  setup: {
    ...
    dailyHint: 'Herkese aynı kelime, gece yarısı değişir',
  ...
  game: {
    ...
    share: 'Sonucu kopyala',
    shareCopied: 'Sonuç panoya kopyalandı.',
    dailyNumber: 'Günlük #{number}',
    ...
    sourceUnreachable: 'Sözlüğe ulaşılamadı. Bağlantınızı kontrol edip tekrar deneyin.',
  ...
  errors: {
    ...
    offlineMode: 'Çevrimdışısınız. Biten oyunlar ve istatistikler çalışır; yeni tahminler bağlantı ister.',
...
const DE = {
  ...
  setup: {
    ...
    dailyHint: 'Für alle dasselbe Wort, wechselt um Mitternacht',
  ...
  game: {
    ...
    sourceUnreachable: 'Das Wörterbuch ist nicht erreichbar. Verbindung prüfen und nochmal versuchen.',
  ...
  errors: {
    ...
    offlineMode: 'Du bist offline. Beendete Spiele und Statistiken gehen weiter; neue Versuche brauchen Verbindung.',
